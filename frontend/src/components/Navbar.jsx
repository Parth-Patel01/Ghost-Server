      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          <div className="flex items-center">
            <FilmIcon className="h-6 w-6 sm:h-8 sm:w-8 text-primary-600" />
            <span className="ml-2 text-lg sm:text-xl font-bold text-gray-900">
              <span className="hidden sm:inline">Pi Media Server</span>
              <span className="sm:hidden">Pi Media</span>
            </span>
          </div>
        ...
        {isMobileMenuOpen && (
          <div className="md:hidden">
            <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3 border-t border-gray-200">
              ...
              <div className="flex items-center px-3 py-2 text-sm text-gray-500 border-t border-gray-200 mt-2 pt-2">
                <div className="w-2 h-2 bg-green-500 rounded-full mr-2"></div>
                Online
              </div>
            </div>
